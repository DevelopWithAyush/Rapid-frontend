...
const ChatHeader = ({ chatId, userTyping, IamTyping }) => {
    ...
    return (
        <div className="h-[7%] fixed top-0 left-0 lg:relative w-full flex flex-row items-center justify-between bg-gradient-to-r from-[#FF889c] to-[#6eab5e] rounded-t-lg py-2 px-6">
