...
const Footer = () => {
    return (
        <div className="bg-black flex w-full flex-col items-center justify-between gap-5 border-t py-[100px] px-[5%] sm:flex-row border-white border-opacity-10 mt-[100px] md:mt-[140px] xl:mt-[200px]">
