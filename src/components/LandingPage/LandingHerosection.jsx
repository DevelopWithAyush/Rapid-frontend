...
const Male = () => {
    return (
        <div className='z-10 absolute top-[40%] -translate-x-[70%] right-0 flex flex-row  items-center justify-center'>
            ...
            <div className='flex py-6 px-5 justify-center items-center rounded-t-[20px] rounded-br-[20px] bg-white text-[24px] font-mon_bold  '
                style={{
...
const Female = ({content, top,right}) => {
    return (
        <div className='z-10 absolute   flex flex-row-reverse  items-center justify-center' style={{
            ...
            <div className='flex py-6 px-5 justify-center items-center rounded-t-[20px] rounded-bl-[20px] text-white bg-[#FF541E] text-[24px] font-mon_bold  '
                style={{
                    boxShadow:" 4px 4px 83.4px 0px rgba(0, 0, 0, 0.30)"
                }}>{ content}</div>
        </div>
